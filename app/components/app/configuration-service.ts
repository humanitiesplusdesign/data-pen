namespace fibra {
  ...
  export class ConfigurationService {
    ...
    public presetAuthorities: EndpointConfiguration[] = []
    public presets: Configuration[] = []
    ...
    constructor(private workerService: WorkerService, private $localStorage: any) {
      ...
      `)
      this.presetAuthorities.push(sdfbConfiguration)
      ...
      `)
      this.presetAuthorities.push(procopeConfiguration)
      ...
      this.presetAuthorities.push(ulanConfiguration)
      ...
      this.presetAuthorities.push(tgnConfiguration)
      ...
      this.presetAuthorities.push(viafConfiguration)
      ...
      this.presetAuthorities.push(geonamesConfiguration)
      ...
      this.presetAuthorities.push(ladbpediaConfiguration)
      ...
      this.presetAuthorities.push(pleiadesConfiguration)
      let c: Configuration
