...
gulp.task('watch', ['build'], function() {
  ...
  $.watch("app/services/**/*.ts", $.batch(function (events, done) { gulp.start('scripts',done); }));
  $.watch("app/models/**/*.ts", $.batch(function (events, done) { gulp.start('scripts',done); }));
  $.watch("app/filters/**/*.ts", $.batch(function (events, done) { gulp.start('scripts',done); }));
  ...
  $.watch("app/*.ts", $.batch(function (events, done) { gulp.start('scripts',done); }));
